...
from dilflow.main_train import main as train_dilflow
from dilflow.main_sample import main as sample_dilflow

from oheflow.main_train import main as train_oheflow
